...
<body>
    ...
    <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Listado facturas</h1>
                </div>
                <!-- /.col-lg-12 -->
    		</div>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php 
									class Factura_lista
								    {
								        ...
								        {
                                            $iidFactura=stripslashes($row["idFactura"]);
								            $ffecha_impre=stripslashes($row["Fecha_impresion"]);
								            $nnumero_mesa=stripslashes($row["Numero_mesa"]);
                                            $nnombre_clien=stripslashes($row["Nombre_cliente"]);
								            $ccedula_clien=stripslashes($row["Cedula_cliente"]);
                                            $nnombre_usuario=stripslashes($row["Nombre_usuario"]);
								            								            
								            echo "<tr class='odd gradeX'>";

								            echo "<td>$iidFactura</td>";
								            echo "<td>$ffecha_impre</td>";
                                            echo "<td>$nnumero_mesa</td>";
								            echo "<td>$nnombre_clien</td>";
                                            echo "<td>$ccedula_clien</td>";
                                            echo "<td>$nnombre_usuario</td>";
