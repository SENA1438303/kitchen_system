...
if(isset($_REQUEST['action']))
{
	...
	{
		case 'registrar':
			$alm->__SET('Descripcion_categoria',                        $_REQUEST['Descripcion_categoria']);

			$model->Registrar($alm);
			header('Location: create_catego.php');
			break;
	}
}
*/
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" name="formu_user" method="POST" action="nego_interfaz/nego_create_categ.php">
                                    	<input type="hidden" name="idCategoria" value="<?php echo $alm->__GET('idCategoria'); ?>" />
                                        <div class="form-group">
                                            <label>Nombre de la categoria</label>
                                            <input class="form-control" name="Descripcion_categori" placeholder="Nombre categoria" required="" autocomplete="off" value="<?php echo $alm->__GET('Descripcion_categoria'); ?>">
                                        </div>
                                        <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">Registrar categoria</button>
