...
if(isset($_REQUEST['action']))
{
	...
	{
		case 'registrar':
			$alm->__SET('Nombre_empresa',                               $_REQUEST['Nombre_empresa']);
            $alm->__SET('NIT_empresa',                                  $_REQUEST['NIT_empresa']);
            $alm->__SET('Direccion_empresa',                            $_REQUEST['Direccion_empresa']);
            $alm->__SET('Telefono_empresa',                             $_REQUEST['Telefono_empresa']);

			$model->Registrar($alm);
			header('Location: create_provee.php');
			break;
	}
}*/
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" name="formu_user" method="POST" action="nego_interfaz/nego_create_provee.php">
                                        <div class="form-group">
                                            <label>Nombres de la empresa</label>
                                            <input class="form-control" name="Nombre_empresa" placeholder="Nombre completo" required="" autocomplete="off" value="<?php echo $alm->__GET('Nombre_empresa'); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>NIT</label>
                                            <input class="form-control" name="NIT_empres" placeholder="Registro Unico" required="" autocomplete="off" value="<?php echo $alm->__GET('NIT_empresa'); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Direccion de la empresa</label>
                                            <input class="form-control" name="Direccion_empresa" placeholder="Ubicación" required="" autocomplete="off" value="<?php echo $alm->__GET('Direccion_empresa'); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Telefono de la empresa</label>
                                            <input class="form-control" name="Telefono_empresa" placeholder="Donde comunicarse" required="" autocomplete="off" value="<?php echo $alm->__GET('Telefono_empresa'); ?>">
                                        </div>                                                      
                                        <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">Registrar proveedor nuevo</button>
