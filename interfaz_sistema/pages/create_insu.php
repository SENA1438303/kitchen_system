...
if(isset($_REQUEST['action']))
{
	switch($_REQUEST['action'])
	{
		case 'registrar':
			...
			$model->Registrar($alm);
			header('Location: create_insu.php');
			break;
	}
}
*/
...
<body>
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Crear Insumo</h1>
            </div>
                <!-- /.col-lg-12 -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="?action=<?php echo $alm->idInsumo > 0 ? : 'registrar'; ?>" method="POST">
                                    	<input type="hidden" name="idInsumo" value="<?php echo $alm->__GET('idInsumo'); ?>" />
                                        <div class="form-group">
                                            <label>Nombres del insumo</label>
                                            <input class="form-control" name="Nombre_insumo" placeholder="Nombre insumo" required="" autocomplete="off" value="<?php echo $alm->__GET('Nombre_insumo'); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Precio compra</label>
                                            <input class="form-control" name="Precio_compra" placeholder="Sin decimales" required="" autocomplete="off" value="<?php echo $alm->__GET('Precio_compra'); ?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="fk_idProveedor">
                                                ...
                                                ?>
                                                <option value="<?php echo $tpro->__GET('idProveedor') ?>"
                                                <?php echo $tpro->__GET('idProveedor') == $alm->__GET('idProveedor') ? 'selected' : ''?>>
                                                <?php echo $tpro->__GET('Nombre_empresa') ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">Registrar nuevo producto</button>
