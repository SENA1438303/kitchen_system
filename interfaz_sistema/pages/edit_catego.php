...
if(isset($_REQUEST['action']))
{
	switch($_REQUEST['action'])
	{
		case 'actualizar':
			...
			header('Location: edit_catego.php');
			break;
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="?action=<?php echo $alm->idCategoria > 0 ? 'actualizar' : 'registrar'; ?>" method="POST">
                                    	<input type="hidden" name="idCategoria" value="<?php echo $alm->__GET('idCategoria'); ?>" />
                                        <div class="form-group">
                                            <label>Nombre de la categoria</label>
                                            <input class="form-control" name="Descripcion_categoria" required="" autocomplete="off" value="<?php echo $alm->__GET('Descripcion_categoria'); ?>">
                                        </div>                                        
