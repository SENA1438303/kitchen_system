...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <!-- /.row -->
            <div class="row">
                <!-- Aca abajo en col-lg-1 cambiar el numero por 1-2-3 depende de la posicion -->
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-primary">
                        ...
                        <a href="factura_presen.php">
                        <div class="panel-footer">Ir a caja</span>
                    ...
                    <div class="panel panel-green">
                        ...
                        <a href="#">
                            <div class="panel-footer">
                                <span class="pull-left">Ir a reporte de ventas</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-yellow">
                        ...
                        <a href="#">
                            <div class="panel-footer">
                                <span class="pull-left">Ir a caja de facturacion</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-red">
                        ...
                        <a href="stock_insu.php">
                            <div class="panel-footer">
                                <span class="pull-left">Ir a inventario</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i>Estadisticas de ventas
                        </div>
                        <!-- /.panel-heading -->
