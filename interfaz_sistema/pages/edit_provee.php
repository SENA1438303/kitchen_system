...
if(isset($_REQUEST['action']))
{
	switch($_REQUEST['action'])
	{
		case 'actualizar':
			...
			header('Location: edit_provee.php');
			break;
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="?action=<?php echo $alm->idProveedor > 0 ? 'actualizar' : 'registrar'; ?>" method="POST">
                                    	<input type="hidden" name="idProveedor" value="<?php echo $alm->__GET('idProveedor'); ?>" />
                                        <div class="form-group">
                                            <label>Nombres de la empresa</label>
                                            <input class="form-control" name="Nombre_empresa" required="" autocomplete="off" value="<?php echo $alm->__GET('Nombre_empresa'); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>NIT</label>
                                            <input class="form-control" name="NIT_empresa" required="" autocomplete="off" value="<?php echo $alm->__GET('NIT_empresa'); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Direccion de la empresa</label>
                                            <input class="form-control" name="Direccion_empresa" required="" autocomplete="off" value="<?php echo $alm->__GET('Direccion_empresa'); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Telefono de la empresa</label>
                                            <input class="form-control" name="Telefono_empresa" required="" autocomplete="off" value="<?php echo $alm->__GET('Telefono_empresa'); ?>">
                                        </div>
							                            ...
							                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
							                                ...
							                                <?php foreach($model->Listar() as $r): ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $r->__GET('NIT_empresa'); ?></td>
                                                                    <td><?php echo $r->__GET('Direccion_empresa'); ?></td>
                                                                    <td><?php echo $r->__GET('Telefono_empresa'); ?></td>
