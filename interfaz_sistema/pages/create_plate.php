...
if(isset($_REQUEST['action']))
{
	switch($_REQUEST['action'])
	{
		case 'registrar':
			...
			$model->Registrar($alm);
			header('Location: create_plate.php');
			break;
	}
}
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="?action=<?php echo $alm->idProducto > 0 ? : 'registrar'; ?>" method="POST">
                                    	<input type="hidden" name="idProducto" value="<?php echo $alm->__GET('idProducto'); ?>" />
                                        <div class="form-group">
                                            <label>Nombres del producto</label>
                                            <input class="form-control" name="Nombre_producto" placeholder="Nombre producto" required="" autocomplete="off" value="<?php echo $alm->__GET('Nombre_producto'); ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Precio producto</label>
                                            <input class="form-control" name="Precio_producto" placeholder="Sin decimales" required="" autocomplete="off" value="<?php echo $alm->__GET('Precio_producto'); ?>">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="fk_idInsumo">
                                                ...
                                                <?php
			                                        $tinsu = new InsumoModel();
			                                        foreach($tinsu->Listar() as $tins):
			                                    ?>
