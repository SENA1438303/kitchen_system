                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php 
                                    class Insumo_lista
                                    {
                                        ...
                                        {
                                            $nnombre_insu=stripslashes($row["Nombre_insumo"]);
                                            $pprecio_compra=stripslashes($row["Precio_compra"]);
                                            $ffk_idCate=stripslashes($row["fk_idCategoria"]);
                                            $ffk_idProvee=stripslashes($row["fk_idProveedor"]);
                                                                                        
                                            echo "<tr class='odd gradeX'>";

                                            echo "<td>$nnombre_insu</td>";
                                            echo "<td>$pprecio_compra</td>";
                                            echo "<td>$ffk_idCate</td>";
                                            echo "<td>$ffk_idProvee</td>";
