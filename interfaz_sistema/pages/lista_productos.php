...
<body>
    ...
    <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Listado de inventario</h1>
                </div>
                <!-- /.col-lg-12 -->
    		</div>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            	<thead>
                                    <tr>
                                        ...
                                        <th>Insumo perteneciente</th>
                                    </tr>
                                </thead>
                                <tbody>
                                <?php 
									class Producto_lista
								    {
								        public function listar_produc()
								        {
								            //SESSION_START();
								        ...
								        {
								            $nnombre_product=stripslashes($row["Nombre_producto"]);
								            $pprecio_product=stripslashes($row["Precio_producto"]);
                                            $ffk_idInsumo=stripslashes($row["fk_idInsumo"]);
								            								            
								            echo "<tr class='odd gradeX'>";

								            echo "<td>$nnombre_product</td>";
								            echo "<td>$pprecio_product</td>";
								            echo "<td>$ffk_idInsumo</td>";
