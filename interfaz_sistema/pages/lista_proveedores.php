...
<body>
    ...
    <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Listado proveedores</h1>
                </div>
                <!-- /.col-lg-12 -->
    		</div>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php 
									class Proveedores_lista
								    {
								        ...
								        {
								            $nnombre_empre=stripslashes($row["Nombre_empresa"]);
								            $nnit_empre=stripslashes($row["NIT_empresa"]);
                                            $ddirección_empre=stripslashes($row["Direccion_empresa"]);
								            $ttelefono_empre=stripslashes($row["Telefono_empresa"]);
								            								            
								            echo "<tr class='odd gradeX'>";

								            echo "<td>$nnombre_empre</td>";
								            echo "<td>$nnit_empre</td>";
                                            echo "<td>$ddirección_empre</td>";
								            echo "<td>$ttelefono_empre</td>";
